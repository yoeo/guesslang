...
# -*- coding: utf-8 -*-
#
# Guesslang documentation build configuration file, created by
# sphinx-quickstart on Thu May 18 22:25:44 2017.
#
...
project = 'Guesslang'
copyright = '{}, Y. SOMDA'.format(datetime.now().year)
author = 'Y. SOMDA'
...
version = read_version('guesslang')
...
htmlhelp_basename = 'Guesslangdoc'
...
latex_documents = [
    (master_doc, 'Guesslang.tex', 'Guesslang Documentation',
     'Y. SOMDA', 'manual'),
]
...
man_pages = [
    (master_doc, 'guesslang', 'Guesslang Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Guesslang', 'Guesslang Documentation',
     author, 'Guesslang', 'Guess programming language of a source code.',
     'Miscellaneous'),
]
